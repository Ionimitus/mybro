...
const QUOTES = [
  ...
  { text: "You don't have to be great to start, but you have to start to be great.", author: "Zig Ziglar", sub: "Begin today" },
  { text: "Strength does not come from the body. It comes from the will.", author: "Unknown", sub: "Mind over matter" },
  { text: "Your body can stand almost anything. It's your mind you have to convince.", author: "Unknown", sub: "Push past the limit" },
  { text: "Train insane or remain the same.", author: "Fitness Mantra", sub: "No shortcuts" },
];
